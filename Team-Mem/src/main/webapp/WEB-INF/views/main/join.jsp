...
<f:form class="join">
  ...
  <div>
    <label>이름</label><input placeholder="NAME" name="u_name" />
  </div>
  <div>
    <label>주소</label><input placeholder="ADDRESS" name="u_addr" />
  </div>
  <div>
    <label>전화번호</label><input placeholder="TEL" name="u_tel" />
  </div>
  <div>
    <label>업체명</label><input placeholder="업체명" name="u_comp" />
  </div>
  <div>
