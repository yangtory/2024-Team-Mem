    ...
    <div class="card">
        ...
        <div class="container">
            ...
            <div class="info">
                <div>
                    <strong>가격</strong>
                    <p><fmt:formatNumber value="${MINFO.i_price}" pattern="#,###" /></p>
                </div>
                <div>
                    <strong>잔여횟수</strong>
        ...
        <div class="detail btn_box">
            <a class="button-32" href="${rootPath }/customer/tickupdate/${MINFO.r_uid}/${MINFO.r_iseq}">수정</a>
            <a class="button-32" href="${rootPath }/customer/tickdelete/${MINFO.r_uid}/${MINFO.i_seq}">삭제</a>
        </div>
    </div>
</div>
