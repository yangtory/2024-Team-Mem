document.addEventListener("DOMContentLoaded", () => {
  ...
  const content = notice_form?.querySelector(
  ...
  const notice_update = document.querySelector(
    "button.notice_update"
  );
  const notice_delete = document.querySelector(
  ...
  document.querySelectorAll(".table_div table tr").forEach((row) => {
    row.addEventListener("click", () => {
      ...
      if (seq) {
        ...
        notice_update.setAttribute(
          "href",
          `${rootPath}/notice/update/${seq}`
        );
        notice_delete.setAttribute(
          "href",
          `${rootPath}/notice/delete/${seq}`
        );
